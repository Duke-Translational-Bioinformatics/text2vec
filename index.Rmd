...
output:
  html_document:
    ...
    toc_float: false
---
You just discovered **[text2vec](https://github.com/dselivanov/text2vec)**!

**text2vec** is an R package which provides an efficient framework with a concise API for text analysis and natural language processing (NLP). 

Goals which we aimed during the development of `text2vec`:
...
<img src="images/htop.png" id="lead-logo" class="pull-right"/>