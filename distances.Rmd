...
```{r}
dim(d1_d2_jac_sim)
d1_d2_jac_sim[1:5, 1:5]
```
Also we can comptute *"parallel"* similarity. Note, that user have to provide matrices with equal shapes:
```{r}
dtm1_2 = dtm1[1:200, ]
dtm2_2 = dtm2[1:200, ]
...
Also we can apply different row normalization techniques:
```{r}
